            ...
            if (selectedDataPointIndex == index) {
                ...
                val textPositionX =
                    if (selectedDataPointIndex == visibleDataPointsIndices.last) {
                        // avoids overlapping of text at the last position beyond the canvas boundary
...
private fun getSelectedDataPointIndex(
    ...
    return drawPoints.indexOfFirst { point ->
        point.x in triggerRangeLeft..triggerRangeRight
    }
}
